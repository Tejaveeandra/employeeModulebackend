...
/**
 * DTO for Bank Info Tab (Step 8)
 * Maps to: BankDetails entity
...
public class BankInfoDTO {
	...
	private Integer bankId; // From "Bank Name" dropdown - maps to OrgBank.org_bank_id (ONLY for Salary Account)
	private Integer bankBranchId; // From "Bank Branch" dropdown - maps to OrgBankBranch.org_bank_branch_id (ONLY for Salary Account)
